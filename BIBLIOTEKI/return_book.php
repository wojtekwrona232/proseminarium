                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-header mbutton" style="border-radius: 0.2em;" >
                                        <h3><i class="fas fa-book"></i>&nbsp;&nbsp;Zwróć książkę</h3>
                                    </div>
                                    ...
                                    <div class="text-center mt-4">
                                        <button type="submit" name="submit" class="btn mbutton special_button ">Zwróć książkę</button>
                                    </div>
                                </div>
                                <?php
                                if (isset($_POST['submit'])) {
                                    ...
                                    $cURLConnection = curl_init('http://127.0.0.1:7010/api/v1/update-reservation');
