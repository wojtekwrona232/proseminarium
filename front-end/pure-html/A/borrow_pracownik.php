                        ...
                        <div class="card wow fadeIn" data-wow-delay="0.3s">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <select name="klient" class="mdb-select md-form" searchable="Znajdź czytelnika...">
                                    <?php // Klient
                                    ...
                                    ?> 
                                        ...
                                        <option value="1" >Jan Nowak
                                        </option>
                                        <option value="2" >Michał Romak
                                        </option>
                                        <option value="3" >Grzesiek Czesiek
                                        </option>
                                    </select>
                                    <label class="mdb-main-label">Czytelnik</label>
                                    ...
                                    <div class="md-form mb-2">
                                        <input placeholder="Selected date" name="date-pick" type="text" id="date-picker-example"
                                ...
                                if (isset($_POST['submit'])) {
                                    $selected_book = $_POST['ksiazka'];
                                    $selected_client = $_POST['klient'];
